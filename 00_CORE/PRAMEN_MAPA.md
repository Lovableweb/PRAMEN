...
**Poslední aktualizace:** 2026-09-26 · Nové prompty K3 v0.1 (`PRAMEN_NOVE_PROMPTY_K3_v0.1.md`).
...
| Soubor | ř. | ČÍST | Co to je / stav |
|---|---:|---|---|
| `PRAMEN_NOVE_PROMPTY_K3_v0.1.md` | 312 | ⭐ | **Nové image prompty K3 — NÁVRH v0.1** pro str. 11, 12, 16, 19, 24, 25 (druhý agent + kontrola Claude Code). Neschváleno, není Vizuální Lock. **3 odchylky od popisů panelů K3** (str. 16 panel 3, str. 11 panel 4, str. 12 panel 4) k vyřešení. Archivní prompty nepřepsány |
