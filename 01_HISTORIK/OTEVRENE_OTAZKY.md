# PRAMEN – HISTORIK
## OTEVŘENÉ HISTORICKÉ OTÁZKY

Tento dokument je pracovní zásobník historických otázek projektu PRAMEN.

ÚČEL:

Zapisovat otázky, na které současný výzkum neposkytl dostatečně
ověřenou odpověď.

Otázky mohou pocházet ze dvou zdrojů:

1. otázky objevené během historických research,
2. doplňující otázky navržené Řídícím mozkem PRAMENU.

ZÁSADNÍ PRAVIDLO:

NEVÍME = OTEVŘENÁ OTÁZKA.

Neověřená informace nesmí být automaticky považována za historický fakt.

Historik má následně hledat odpovědi v dostupných pramenech,
odborné literatuře, archivech, katalozích a dalších důvěryhodných zdrojích.
...
🟡 ROZPRACOVÁNO / VYŽADUJE OVĚŘENÍ

🟢 OVĚŘENO

⚠️ ROZPOR / VYŽADUJE ROZHODNUTÍ

---

# 1. OTÁZKY VYPLÝVAJÍCÍ Z DOSAVADNÍHO HISTORICKÉHO VÝZKUMU

### HIST-001
- ID: HIST-001
- OTÁZKA: Kde přesně se v díle Caspara Schwenckfeldta z roku 1607 nachází část věnovaná Bílinské kyselce a co přesně Schwenckfeldt o Bílině píše?
- TÉMA: Schwenckfeldt 1607 – Bílina
- PROČ JE OTÁZKA OTEVŘENÁ: Přímý primární text relevantní pasáže nebyl získán.
- DOSAVADNÍ STAV: 🟡 DIGITALIZÁT NALEZEN; obsah relevantní pasáže nebyl přímo přečten.
- CO BY MĚLO BÝT DOHLEDÁNO: Čitelný obraz nebo OCR originálního textu, tištěná strana, digitální strana a název oddílu.
- DŮLEŽITOST PRO KOMIKS: Umožní bezpečně určit, co lze o rané historii Bílinské kyselky zobrazit nebo uvést.
- STAV: 🔴 OTEVŘENO / 🟡 VYŽADUJE OVĚŘENÍ

### HIST-002
- ID: HIST-002
- OTÁZKA: Jaké historické označení pramene Schwenckfeldt používá, zda skutečně používá označení „Salsula-Sältzling“ nebo jinou podobu a co přesně uvádí o soli, vápnu a využívání pramene?
- TÉMA: Schwenckfeldt 1607 – terminologie a popis pramene
- PROČ JE OTÁZKA OTEVŘENÁ: Výskyty výrazů „Salsula“, „Sältzling“, „Saltz“, „Sauerbrunn“ ani jejich variant nebyly ověřeny v přečteném originálním textu.
- DOSAVADNÍ STAV: 🟡 SEKUNDÁRNÍ TVRZENÍ; přímý zápis nebyl ověřen.
- CO BY MĚLO BÝT DOHLEDÁNO: Přesný originální zápis a stránka, včetně obrazové kontroly OCR.
- DŮLEŽITOST PRO KOMIKS: Zabrání použití modernizované nebo nepřesné historické terminologie.
- STAV: 🔴 OTEVŘENO / 🟡 VYŽADUJE OVĚŘENÍ

### HIST-003
- ID: HIST-003
- OTÁZKA: Zda a jak Schwenckfeldt odkazuje na starší prameny či Hájka a co přesně uvádí o původu nebo historii pramene.
- TÉMA: Schwenckfeldt 1607 – starší prameny a Hájek
- PROČ JE OTÁZKA OTEVŘENÁ: Přímé jmenování Hájka ani konkrétní odkaz na starší pramen nebyly ověřeny v originálním textu.
- DOSAVADNÍ STAV: 🟡 NEOVĚŘENO V PRIMÁRNÍM TEXTU.
- CO BY MĚLO BÝT DOHLEDÁNO: Přesné znění relevantní pasáže a její stránka.
- DŮLEŽITOST PRO KOMIKS: Oddělení skutečného historického odkazu od pozdější tradice.
- STAV: 🔴 OTEVŘENO / 🟡 VYŽADUJE OVĚŘENÍ

### HIST-004
- ID: HIST-004
- OTÁZKA: Jaký je přesný obsah části „Die Geschichte d. Quelle“ v Troschelovi z roku 1762, co uvádí o původu, historii a používání pramene, zda uvádí starší písemné zprávy a zda uvádí datum nebo osobu spojenou s „objevením“ či úpravou pramene?
- TÉMA: Troschel 1762
- PROČ JE OTÁZKA OTEVŘENÁ: Přímý stránkový text uvedené části nebyl v dosavadním výzkumu doložen.
- DOSAVADNÍ STAV: 🟡 VYŽADUJE PŘÍMÉ OVĚŘENÍ.
- CO BY MĚLO BÝT DOHLEDÁNO: Originální digitalizát, přesná kapitola, strany a doslovný přepis relevantní pasáže.
- DŮLEŽITOST PRO KOMIKS: Troschel může být důležitým mezistupněm mezi staršími zmínkami a pozdějšími výklady.
- STAV: 🔴 OTEVŘENO / 🟡 VYŽADUJE OVĚŘENÍ

### HIST-005
- ID: HIST-005
- OTÁZKA: Co přesně Reuss ve svém díle z roku 1788 uvádí o starší historii Bílinské kyselky, zda uvádí konkrétní starší písemné doklady, Hájka, Schwenckfeldta, Troschela nebo jiné starší autory a co znamená jeho vlastní historický výklad počátků pramene?
- TÉMA: Reuss 1788 – historický výklad
- PROČ JE OTÁZKA OTEVŘENÁ: Přímý stránkový text Reussovy práce z roku 1788 nebyl získán.
- DOSAVADNÍ STAV: 🟢 bibliografická existence doložena; 🟡 přímý stránkový text nezískán.
- CO BY MĚLO BÝT DOHLEDÁNO: Přímý text, konkrétní strany, odkazy na starší autory a přesný kontext výkladu.
- DŮLEŽITOST PRO KOMIKS: Reussův výklad nesmí být nahrazen pozdější interpretací.
- STAV: 🔴 OTEVŘENO / 🟡 VYŽADUJE OVĚŘENÍ

### HIST-006
- ID: HIST-006
- OTÁZKA: Jaké jsou nejstarší skutečně doložené písemné zmínky o Bílinské kyselce a co znamená rozdíl mezi „známým pramenem“, „objeveným pramenem“ a pramenem, který „začal být využíván“?
- TÉMA: Historická chronologie před Reussem
- PROČ JE OTÁZKA OTEVŘENÁ: Dosavadní evidence neurčuje úplnou a přímo doloženou chronologii.
- DOSAVADNÍ STAV: 🟡 NEÚPLNĚ OVĚŘENO.
- CO BY MĚLO BÝT DOHLEDÁNO: Primární prameny, přesné citace, datace a význam použitých formulací; zvlášť ověřit, zda existují prameny před rokem 1541.
- DŮLEŽITOST PRO KOMIKS: Zamezí směšování prvního písemného dokladu, objevení a počátku využívání.
- STAV: 🔴 OTEVŘENO / 🟡 VYŽADUJE OVĚŘENÍ

### HIST-007
- ID: HIST-007
- OTÁZKA: Existuje starší nezávislý pramen potvrzující událost spojovanou s rokem 761, nebo jde pouze o pozdější tradici zaznamenanou Hájkem z Libočan, a jaké je přesné znění a původ této tradice?
- TÉMA: Rok 761 a Hájek z Libočan
- PROČ JE OTÁZKA OTEVŘENÁ: Rok 761 nebyl v kontrolované přímé pasáži Schwenckfeldtova textu ověřen.
- DOSAVADNÍ STAV: 🟡 SEKUNDÁRNÍ TVRZENÍ; primární potvrzení nebylo získáno.
- CO BY MĚLO BÝT DOHLEDÁNO: Přesný text tradice, její nejstarší dohledatelný pramen a nezávislé potvrzení či vyvrácení.
- DŮLEŽITOST PRO KOMIKS: Rok 761 nesmí být použit jako historický fakt bez přímého důkazu.
- STAV: 🔴 OTEVŘENO / 🟡 VYŽADUJE OVĚŘENÍ

### HIST-008
- ID: HIST-008
- OTÁZKA: Existují doklady o vývozu, obchodování, stáčení, přepravě nebo léčebném využití Bílinské kyselky v 16.–18. století před vznikem moderní lázeňské tradice?
- TÉMA: Starší období 16.–18. století
- PROČ JE OTÁZKA OTEVŘENÁ: Tyto body nebyly v dosavadním výzkumu doloženy konkrétními primárními doklady.
- DOSAVADNÍ STAV: 🟡 NEOVĚŘENO.
- CO BY MĚLO BÝT DOHLEDÁNO: Dobové písemné doklady o vývozu, obchodu, stáčení, přepravě a léčebném užívání.
- DŮLEŽITOST PRO KOMIKS: Umožní odlišit doložené praktické využití od pozdější lázeňské tradice.
- STAV: 🔴 OTEVŘENO / 🟡 VYŽADUJE OVĚŘENÍ

### HIST-009
- ID: HIST-009
- OTÁZKA: Co přesně znamenají zmínky o letech 1774, 1779, 1781 a 1786, kdo se těchto průzkumů účastnil, jaké prameny je dokládají a zda lze jejich existenci doložit primárním pramenem?
- TÉMA: Expedice a průzkumy před Reussem
- PROČ JE OTÁZKA OTEVŘENÁ: Uvedené roky a události nebyly v dosavadním výzkumu kompletně spojeny s konkrétními primárními prameny.
- DOSAVADNÍ STAV: 🟡 VYŽADUJE PŘÍMÉ OVĚŘENÍ.
- CO BY MĚLO BÝT DOHLEDÁNO: Účastníci, dokumenty, datace, archivní údaje a přesné znění zmínek.
- DŮLEŽITOST PRO KOMIKS: Zabrání vytvoření nepodložené chronologie před Reussem.
- STAV: 🔴 OTEVŘENO / 🟡 VYŽADUJE OVĚŘENÍ

### HIST-010
- ID: HIST-010
- OTÁZKA: Jak se Bílinská kyselka v jednotlivých obdobích skutečně označovala a jak se liší pojmy Sauerbrunn, Sauerbrunnen, Salsula-Sältzling a další historické nebo moderní názvy?
- TÉMA: Historická terminologie
- PROČ JE OTÁZKA OTEVŘENÁ: Nebyl proveden úplný přímý rozbor dobových použití jednotlivých názvů.
- DOSAVADNÍ STAV: 🟡 TERMINOLOGIE NEÚPLNĚ OVĚŘENA.
- CO BY MĚLO BÝT DOHLEDÁNO: Dobové zápisy, jejich datace, jazykový kontext a případná zpětná modernizace názvů.
- DŮLEŽITOST PRO KOMIKS: Přesné názvy jsou součástí historické věrohodnosti dialogů a popisek.
- STAV: 🔴 OTEVŘENO / 🟡 VYŽADUJE OVĚŘENÍ

### HIST-011
- ID: HIST-011
- OTÁZKA: Existuje přímý primární důkaz, že Reuss používal Berzeliovy analytické metody, od kdy lze tuto vazbu bezpečně datovat, zda existuje přímý důkaz osobního kontaktu Reusse s Berzeliem, zda Berzelius osobně navštívil Bílinu a co přesně Berzelius zkoumal v souvislosti se Zaječickou hořkou vodou roku 1840?
- TÉMA: Reuss × Berzelius
- PROČ JE OTÁZKA OTEVŘENÁ: Metodická návaznost nebyla ověřena v primárním textu; osobní spolupráce, Berzelius v Bílině a Berzelius v Bílině roku 1786 zůstávají nedoloženy.
- DOSAVADNÍ STAV: 🟡 metodická vazba neověřena v primárním textu; 🔴 osobní spolupráce a návštěva Bíliny nedoloženy; 🟢 chemické zkoumání Zaječické vody roku 1840 doloženo publikací.
- CO BY MĚLO BÝT DOHLEDÁNO: Přímý text Reuss 1788/1801 a přesný text Berzelius 1840 v relevantních částech.
- DŮLEŽITOST PRO KOMIKS: Zachování oddělení doložených událostí od nepodložené spolupráce.
- STAV: 🔴 OTEVŘENO / 🟡 VYŽADUJE OVĚŘENÍ
...
### HIST-013
- ID: HIST-013
- OTÁZKA: Jaký je status všech dosud zmíněných odkazů na roky 1513, 1664 a další starší datace – zda jde o skutečný primární doklad, sekundární citaci, tradici nebo chybnou interpretaci?
- TÉMA: Další starší zmínky
- PROČ JE OTÁZKA OTEVŘENÁ: Jednotlivé datace nebyly všechny přiřazeny ke konkrétnímu a přímo ověřenému prameni.
- DOSAVADNÍ STAV: 🟡 NEÚPLNĚ OVĚŘENO.
- CO BY MĚLO BÝT DOHLEDÁNO: U každé datace původní dokument, bibliografické údaje, citaci, stránku nebo folio a typ evidence.
- DŮLEŽITOST PRO KOMIKS: Zamezí použití chybných nebo tradovaných dat jako historických faktů.
- STAV: 🔴 OTEVŘENO / 🟡 VYŽADUJE OVĚŘENÍ
...
# 3. PRAVIDLA PRO BUDOUCÍHO HISTORIKA

Historik nesmí pouze odpovědět „ano/ne“.
U každé odpovědi musí být pokud možno uvedeno:
...
- název díla,
- rok,
- strana / folio / kapitola, pokud je dostupná,
- odkaz na digitalizát, katalog nebo archiv, pokud existuje,
- důkazní úroveň,
- případná nejistota.
...
🟢 DOLOŽENO
🟡 VYŽADUJE DALŠÍ OVĚŘENÍ
🔴 NEDOLOŽENO / NELZE POUŽÍT JAKO HISTORICKÝ FAKT
⚠️ SPORNÉ / VYŽADUJE HISTORICKÉ POSOUZENÍ

DŮLEŽITÉ:
Historik může přinést nový pramen nebo nový výklad.
Pokud se objeví rozpor s dosavadním CORE, nesmí být automaticky přepsán CORE.
Rozpor musí být zaznamenán a předán Řídícímu mozku k posouzení.

# 4. PRAVIDLO PRO POZDĚJŠÍ ODPOVĚDI HISTORIKA

Až budou dodány odpovědi historika, jednotlivé odpovědi se mají přiřazovat ke konkrétním ID HIST-xxx.

Odpověď historika se nejprve eviduje zde jako pracovní výsledek.
...
Pokud z dosavadního výzkumu vyplývá dalších 10, 20, 50 nebo více samostatných otázek, zachyť je všechny.

NEZKRACUJ seznam pouze kvůli pohodlí.

# 6. CO NEDĚLAT

- nevymýšlet historické odpovědi,
- nedoplňovat chybějící prameny,
- nepřepisovat historické závěry,
- neoznačovat legendu jako fakt,
- neslučovat sekundární a primární pramen,
- nepovažovat existenci digitalizátu za důkaz obsahu,
- nepovažovat pozdější odbornou interpretaci za přímý důkaz primárního pramene,
- nevytvářet nové historické skutečnosti.
...
| ID | Otázka / otevřený bod | Stav |
|---|---|---|
| OO-K3-01 | **Ověření str. 29** (aktuální fakta epilogu): muzeum Bílinské kyselky otevřené v roce 2026, Karel Bašta jako skutečný průvodce, pokračování výroby. Nelze zjistit z archivů, ověřit u Karla Bašty nebo z oficiálního oznámení. **Záměrně odloženo na pokyn Jirky (2026-09-26).** Do té doby zůstává str. 29 v K2/K3 označená „OVĚŘIT PŘED TISKEM". **Úkol Jirky; mimo lock textu (D-7) — blokuje tisk, ne lock textu.** | 🟡 ODLOŽENO |
